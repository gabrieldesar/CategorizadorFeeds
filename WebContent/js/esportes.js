...
function recuperarListaPostsEsportes(postsSpinner) {
      ...
      jQuery.ajax({
          type: "POST",
          url: rootURL + '/esportes',
          data: accessTokenString,
          contentType: "application/json",
          error: function (xhr, status) {
                  console.log("Ocorreu um erro ao obter a lista de posts sobre esportes: " + status + '.');
              },
          success: function (data, msg) {
              console.log("Lista de posts sobre esportes recuperada com sucesso.");
